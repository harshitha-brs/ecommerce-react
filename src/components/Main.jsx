    ...
    <main className="pt-5 pb-5">
      <section className="container content-section">
        ...
        <div className="shop-items">
          <ShopItem title="Nokia" price="₹10000" image="./assets/images/nokia.jpg" addToCart={addToCart} />
          <ShopItem title="Samsung" price="₹12000" image="./assets/images/sam.png" addToCart={addToCart} />
          <ShopItem title="Apple" price="₹45000" image="./assets/images/apple.jpg" addToCart={addToCart} />
          <ShopItem title="Sony" price="₹20000" image="./assets/images/sony.jpg" addToCart={addToCart} />
          <ShopItem title="One Plus" price="₹65000" image="./assets/images/oneplus.webp" addToCart={addToCart} />
          <ShopItem title="Oppo" price="₹20000" image="./assets/images/oppo1.jpeg" addToCart={addToCart} />
        </div>
      </section>
      <section className="container content-section">
        <h2 className="section-header">Laptop</h2>
        <div className="shop-items">
          <ShopItem title="HP" price="₹50000" image="./assets/images/HP.jpg" addToCart={addToCart} />
          <ShopItem title="Dell" price="₹75000" image="./assets/images/dell.jpg" addToCart={addToCart} />
          <ShopItem title="Samsung" price="₹60000" image="./assets/images/samsung lap.png" addToCart={addToCart} />
          <ShopItem title="Lenova" price="₹65000" image="./assets/images/lenovo.webp" addToCart={addToCart} />
          <ShopItem title="Zebronics" price="₹65000" image="./assets/images/lap1.jpg" addToCart={addToCart} />
          <ShopItem title="Apple" price="₹65000" image="./assets/images/lap2.png" addToCart={addToCart} />
        </div>
      </section>
      <section className="container content-section">
